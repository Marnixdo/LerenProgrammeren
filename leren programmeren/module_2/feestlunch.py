...
print (f"de feestlunch kost je bij de bakker {totaal_prijs} euro voor de {aantal_croissant} croissantjes en de {aantal_stokbrood} stokbroden als de {aantal_kortingsbon} kortingsbonnen nog geldig zijn! ")